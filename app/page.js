...
export default function Home() {
  ...
  const addPic = async (img) =>{
    ...
    const docSnap = await getDoc(docRef)
    await setDoc(docRef, {base64: image})
  ...
  return (
    <Box 
      ...
      gap = {2}
      style = {{
        backgroundImage: 'url(https://assets.vogue.com/photos/6413339476696e47ad932c27/master/w_2560%2Cc_limit/GettyImages-1244252029.jpg)',
    ...
    >
      ...
      <Box border = "3px solid #cfc46d" style = {{
        backgroundImage: 'url(https://www.offidocs.com/images/plastercleanslatebackground.jpg)',
